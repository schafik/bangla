...
baseline_mSD <- select(baseline, 
                       ...
                       live_spouse = dlive_sp, family_dep_food = dmem_dep_food, family_dep_income = dmem_dep_fin, #change factors!
                       education = dedu, write_bangla = dletterb, write_english = dlettere, years_anyGarment = dy_garment, 
                       years_currjob = dy_currjob, years_intendedFut = dy_exp, income_spouse = dsp_inc, monthly_overtime = dinc_over, 
                       ladr_respect = dresp_comm, ladr_currStatus = dcurr_status, ladr_futStatus = dfut_status, 
                       ladr_pastStatus = dpast_status, factory, advice = dadvice, salary = salamount)
```

```{r, results='asis', echo=FALSE}
stargazer(baseline_mSD, type="html", flip = TRUE)
```
...
```{r echo=FALSE, fig.width=2.5, fig.height=3.75, cache=FALSE}
...
```     
```{r, echo=FALSE, fig.width=4, fig.height=3.75, cache=FALSE}
...
#credentials
##education
```{r, echo=FALSE, fig.width=11.5, fig.height=3, cache=FALSE}
...
```{r, echo=FALSE, fig.width=6, fig.height=3.5, warning=FALSE, cache=FALSE}
...
```{r, echo=FALSE, fig.width=12, fig.height=3, cache=FALSE}
...
##advice
```{r, echo=FALSE, fig.width=4, fig.height=2.75, cache=FALSE}
...
##housing arrangement
please describe your living arrangement in Dhaka:

```{r, echo=FALSE, fig.width=14, fig.height=4, cache=FALSE}
plot_percent(baseline, "hhou_D", coordflippin = T) 
```

how many rooms hometown accomodation has?
```{r, echo=FALSE, fig.width=2.5, fig.height=3.75, cache=FALSE}
plot_hist(baseline, "hn_rooms") 
```

##rent per month 
```{r, echo=FALSE, fig.width=14, fig.height=4, cache=FALSE}
plot_percent(baseline, "hrent_D", coordflippin = T) 
```

does it include food/utlities/other?
```{r, echo=FALSE, fig.width=2.5, fig.height=4, cache=FALSE}
plot_percent(baseline, "hrent_incl_yn") 
```

###how to represent?
```{r}
#which of the following amenities does your accommodation in Dhaka have?
 #hamen_D1:hamen_D5
table(baseline$hamen_D1)
```

```{r}
#which of the following amenities does your hometown accommodation have? 
  #hamen_vill1:hamen_vill5
table(baseline$hamen_vill1)
```
